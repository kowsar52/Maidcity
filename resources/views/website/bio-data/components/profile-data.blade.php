        ...
        <div class="col-lg-6 col-md-12">
                <div class="border rounded-3 position-relative p-3">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-6 p-0 @guest filter @endguest">
                        ...
                        <div class="col-12 @guest filter @endguest">
                            ...
                            <div class="mb-1 d-flex flex-wrap gap-1">
                                <small class="text-dark me-1">{{ __('general.jobs') }}:</small>
                                @forelse($d->bioDataDetail->recommended_helper as $r)
                                    <span
                                        class="bg-danger p-1 fs-8 text-white rounded-2">{{ \App\Services\GeneralService::categoryForDropdown($r)}}</span>
                                @empty
