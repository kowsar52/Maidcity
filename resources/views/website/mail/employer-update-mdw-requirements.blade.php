...
<head>
    ...
    <title>Employer Update Mdw Requirements</title>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                <tr>
                    <td align="left" bgcolor="#ffffff"
                        ...
                        <h1 style="margin: 0; font-size: 32px; font-weight: 700; letter-spacing: -1px; line-height: 48px; text-align: center;">Employer Update Mdw Requirements</h1>
                    </td>
                </tr>
            </table>
            <!--[if (gte mso 9)|(IE)]>
    ...
    <tr>
        <td align="center" bgcolor="#e9ecef">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                ...
                <tr>
                    <td align="left" bgcolor="#ffffff"
                        style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;  text-align: left;">
                        ...
                        <table style="width: 100%;">
                            <thead>
                            <tr>
                                <th>Q1. {{ __('general.employer_question_answer1') }}</th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
                                <td>
                                    @foreach(\App\Services\JobService::typeOfMDW() as $key => $answer)
                                        ...
                                        <div style="width: 50%; float: left;">
                                            <input type="checkbox" {{ $answer1 ? 'checked' : '' }} disabled>
                                            <labe>{{ $answer }}</labe>
                                        </div>
                                    @endforeach
                                </td>
                        ...
                        <table style="width: 100%;">
                            <thead>
                            <tr>
                                <th>Q2. {{ __('general.employer_question_answer2') }}</th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
                                <td>
                                    @foreach(\App\Services\JobService::nationalityPreferred() as $key => $answer)
                                        ...
                                        @endphp
                                        <div style="width: 50%; float: left;">
                                            <input type="checkbox" {{ $answer2 ? 'checked' : '' }} disabled>
                                            <labe>{{ $answer }}</labe>
                                        </div>
                                    @endforeach
                                </td>
                        ...
                        <table style="width: 100%;">
                            <thead>
                            <tr>
                                <th>Q3. {{ __('general.employer_question_answer3') }}</th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
                                <td>
                                    @foreach(\App\Services\GeneralService::categoryForDropdown() as $key => $answer)
                                        @php
                                            $answer3 = isset($model) ? \App\Models\EmployerMDWRequirement::where('id',$model->id)->whereJsonContains('answer3',(string)$key)->exists() : false;
                                        @endphp
                                        <div style="width: 50%; float: left">
                                            <input type="checkbox" {{ $answer3 ? 'checked' : '' }} disabled>
                                            <labe>{{ $answer }}</labe>
                                        </div>
                                    @endforeach
                                </td>
                        ...
                        <table style="width: 100%;">
                            <thead>
                            <tr>
                                <th>Q4. {{ __('general.employer_question_answer4') }}</th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
                        ...
                        <table style="width: 100%;">
                            <thead>
                            <tr>
                                <th>Q5. {{ __('general.employer_question_answer5') }}</th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
                                <td>
                            @foreach(\App\Services\GeneralService::getBranch() as $key => $answer)
                                @php
                                ...
                                @endphp
                                        <div style="width: 50%; float: left;">
                                            <input type="checkbox" {{ $answer5 ? 'checked' : '' }} disabled>
                                            <labe>{{ $answer }}</labe>
                                        </div>
                            @endforeach
                                </td>
