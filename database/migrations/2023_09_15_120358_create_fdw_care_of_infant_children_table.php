...
return new class extends Migration {
    ...
    {
        Schema::create(TableEnum::FDW_CARE_OF_INFANT_CHILDREN, function (Blueprint $table) {
            $table->id();
            $table->foreignId('fdw_bio_data_id')->constrained(TableEnum::FDW_BIO_DATA)->on(TableEnum::FDW_BIO_DATA)->cascadeOnDelete();
            $table->integer('skill_title')->nullable();
    ...
    {
        Schema::dropIfExists(TableEnum::FDW_CARE_OF_INFANT_CHILDREN);
    }
};
